...
# [![Typing SVG](https://readme-typing-svg.herokuapp.com?size=28&duration=4000&color=1DC3B8&center=false&vCenter=true&lines=👋+Hi!+I'm+Mason+Kim;Full+Stack+Developer;UI%2FUX+Enthusiast;Always+Learning+Something+New!)](https://git.io/typing-svg)

I'm a **Full-Stack Developer** passionate about creating **minimalistic, efficient, and accessible** web applications.

---

### 💼 About Me
- 🔭 **Currently building:** [**Portfolio-2025**](https://github.com/masonkimm/portfolio-2025) — a React + Vite single-page portfolio site showcasing my projects, experience, and UI/UX design 
- ⚙️ **Tech Stack:** React (Vite, Ant Design, Tailwind), Flask, SQLAlchemy, PostgreSQL  
- ☁️ **Learning:** Data Structures & Algorithms, AWS Developer Certification, and AI tools for automation  
- 🧠 **Interests:** Web architecture, performance optimization, and elegant UI/UX design  
- 🎾 **Fun Fact:** When I’m not coding, I’m probably on the tennis court or golf course  
...
⭐️ *“Clean code, clean design — one line at a time.”*
